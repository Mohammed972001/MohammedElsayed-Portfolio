...
export default function Tools() {
  return (
    ...
    <div class="flex items-center   p-4 rounded-2xl border border-zinc-700">
      <img  src="/src/assets/figma.svg" alt="Figma" class="w-10 h-10 mr-4"/>
      <div>
    ...
    <div class="flex items-center   p-4 rounded-2xl border border-zinc-700">
      <img src="/src/assets/css3.svg" alt="CSS" class="w-10 h-10 mr-4"/>
      <div>
    ...
    <div class="flex items-center  p-4 rounded-2xl border border-zinc-700">
      <img src="/src/assets/javascript.svg" alt="JavaScript" class="w-10 h-10 mr-4"/>
      <div>
    ...
    <div class="flex items-center  p-4 rounded-2xl border border-zinc-700">
      <img src="/src/assets/nodejs.svg" alt="NodeJS" class="w-10 h-10 mr-4"/>
      <div>
    ...
    <div class="flex items-center  p-4 rounded-2xl border border-zinc-700">
    <img src="/src/assets/expressjs.svg" alt="NodeJS" class="w-10 h-10 mr-4"/>
    <div>
    ...
    <div class="flex items-center   p-4 rounded-2xl border border-zinc-700">
      <img src="/src/assets/mongodb.svg" alt="MongoDB" class="w-10 h-10 mr-4"/>
      <div>
    ...
    <div class="flex items-center  p-4   rounded-2xl border border-zinc-700">
    <img src="/src/assets/tailwindcss.svg" alt="NodeJS" class="w-10 h-10 mr-4"/>
    <div>
    ...
    <div class="flex items-center  p-4 rounded-2xl border border-zinc-700">
      <img src="/src/assets/react.svg" alt="React" class="w-10 h-10 mr-4"/>
      <div>
